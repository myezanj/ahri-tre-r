test_that("protocol ranges overlap only when compatible", {
  expect_true(ahriTRErRs:::protocol_ranges_overlap("0.1.0", "0.1.999", "0.1.0", "0.1.0"))
  expect_true(ahriTRErRs:::protocol_ranges_overlap("0.1.0", "0.1.999", "0.1.5", "0.2.0"))
  expect_false(ahriTRErRs:::protocol_ranges_overlap("0.1.0", "0.1.999", "0.2.0", "0.2.999"))
})
